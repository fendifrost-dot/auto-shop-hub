    ...
    <div className="space-y-6">
            ...
            <DialogContent className="sm:max-w-lg">
              ...
              <div className="grid gap-3 py-2">
                <div className="space-y-2">
                  ...
                  <Input id="jobNumber" value={jobNumber} onChange={(e) => setJobNumber(e.target.value)} placeholder="e.g. 2026-1042" />
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="vehicle" value={vehicleInfo} onChange={(e) => setVehicleInfo(e.target.value)} />
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <Select value={assignedTo} onValueChange={setAssignedTo}>
                    <SelectTrigger>
                      <SelectValue placeholder={profilesQuery.isLoading ? "Loading…" : "Unassigned"} />
                    </SelectTrigger>
                    <SelectContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {canManage ? "All shop jobs." : "Jobs assigned to you."}
          </CardDescription>
        </CardHeader>
        <CardContent>
          {jobsQuery.isLoading ? (
